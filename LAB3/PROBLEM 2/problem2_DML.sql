...
INSERT INTO memeber VALUES ('1','Gerhard Roberts','14492 Bode Neck Apt. 916\nWest Lorenaport, NY 42896','1983-09-14 11:39:02'), 
...
-- requirements
 select name from memeber where join_date > '20000901';
 select * from memeber where join_date between '1995-10-1' and '2019-10-01';
 select * from book inner join publisher on publisher.name='Oxford' or book.price between 15 and 20;
 select title from book inner join borrowing_book on borrowing_book.book_id=book.book_id inner join memeber on borrowing_book.member_id=memeber.member_id and memeber.name='scot reinger';
 select name from memeber inner join borrowing_book on borrowing_book.member_id=memeber.member_id between '20190101' and '20191231';
 select * from book where price between 15.0 and 20.0 or pub_id=(select pub_id from publisher where name = 'Oxford');
